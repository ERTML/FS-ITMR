...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const headerElement = document.querySelector("readme.md-header__inner");
  const searchContainer = headerElement?.querySelector("readme.md-header__source");
  ...
  if (headerElement && searchContainer) {
    ...
    const defaultSearchDialog = document.querySelector("readme.md-search");
...
(() => {
  function fixLanguageLinks() {
    ...
    const links = document.querySelectorAll("readme.md-select__link[hreflang]");
